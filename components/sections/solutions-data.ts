...
export const SOLUTIONS: Solution[] = [
  ...
  tagline: "Automate conversations, sales & support",
  description:
    "Streamline communication with intelligent WhatsApp automation systems that handle customer queries, send updates, and drive conversions while reducing manual workload.",
  ...
  technologies: ["WhatsApp API", "Node.js", "Dialogflow", "Twilio", "MongoDB"],
  useCases: [
...
},
{
  ...
  tagline: "Smart systems that learn and improve",
  description:
    "Leverage artificial intelligence to automate processes, gain insights, and enhance user experiences with intelligent systems tailored to your business.",
  image: "/images/ai.jpg",
  features: [
  ...
  technologies: ["OpenAI", "Python", "TensorFlow", "LangChain", "FastAPI"],
  useCases: [
    "Customer support AI",
    "Fraud detection",
...
},
{
  ...
  tagline: "Secure, transparent & decentralized systems",
  description:
    "Build trust and security with blockchain-powered applications, smart contracts, and decentralized solutions designed for transparency and reliability.",
...
},
{
  ...
  tagline: "Protect systems, data & infrastructure",
  description:
    "Secure your applications and infrastructure with comprehensive audits, vulnerability testing, and proactive defense strategies.",
  ...
  technologies: ["OWASP", "Burp Suite", "Wireshark", "Metasploit", "SIEM"],
  useCases: [
    "Enterprise systems",
    "Financial platforms",
    "Healthcare software",
...
},
{
  ...
  tagline: "Growth strategies that scale brands",
  description:
    "Boost visibility, engagement, and revenue with data-driven social media management and high-converting ad campaigns.",
  ...
  technologies: ["Meta Ads", "Google Analytics", "Hootsuite", "HubSpot"],
  useCases: [
