...
export function TrustSignals() {
  ...
  return (
    <section aria-labelledby="trust-heading" className="relative w-full py-24 md:py-32 lg:py-40 z-30 md:px-12 lg:px-16">
      {/* Subtle Background */}
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        <h2
          id="trust-heading"
          className="text-3xl md:text-4xl lg:text-5xl font-black tracking-[-0.04em] leading-[1.1] text-text-primary mb-20 text-center md:text-left"
        >
          {HEADLINE}
        </h2>

        <ul className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8 " role="list">
          {SIGNALS.map((item, i) => {
            const Icon = ICONS[i];
            return (
              <motion.li
