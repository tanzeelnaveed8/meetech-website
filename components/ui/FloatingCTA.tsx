  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="hidden group-hover:inline transition-all duration-400">WhatsApp</span>
      </Link>
      ...
      >
        ...
        <span className="hidden group-hover:inline transition-all duration-400">Book a Call</span>
      </Link>
    </motion.div>
  );
}
