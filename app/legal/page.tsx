  ...
  return (
    <div className="mx-auto max-w-4xl">
      <PageHero
        ...
        description="Our commitment to transparency. Review our privacy practices and terms of service."
      />
      ...
      >
        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link
            ...
            className="inline-flex min-h-[48px] items-center justify-center gap-2 rounded-lg bg-accent px-6 py-3 text-base font-semibold text-text-inverse shadow-sm transition-all duration-200 hover:bg-accent-hover hover:shadow-md active:bg-accent-active focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-2 focus-visible:ring-offset-bg-page"
          >
            <svg
              className="h-5 w-5"
              fill="currentColor"
