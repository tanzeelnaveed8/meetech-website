               ...
               <section className="relative z-10 py-24 md:py-32 overflow-hidden">
                    <div className="mx-auto max-w-7xl px-6 md:px-8">
                         <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-24">
                              ...
                              <div className="flex p-2 bg-bg-card border border-border-subtle rounded-3xl w-fit shadow-xl overflow-x-auto">
                                   {categories.map((cat) => (
                                        <button
                                             key={cat.id}
                                             onClick={() => setSelectedCategory(cat.id)}
                                             className={`flex items-center gap-3 px-8 py-4 rounded-2xl text-[11px] font-black tracking-widest uppercase transition-all duration-500 whitespace-nowrap ${selectedCategory === cat.id
